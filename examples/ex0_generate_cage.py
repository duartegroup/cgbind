...
# Generate a linker name and SMILES string (which can be generated in Chemdraw using Edit/Copy As/SMILES)
linker = Linker(name='linker', smiles='C1(C#CC2=CC=CC(C#CC3=CC=CN=C3)=C2)=CC=CN=C1', arch_name='m2l4')
